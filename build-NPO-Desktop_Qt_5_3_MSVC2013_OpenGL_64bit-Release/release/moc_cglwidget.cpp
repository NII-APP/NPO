...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CGLWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(10, 87, 14)
    },
    "CGLWidget\0transformIdentity\0\0initialZoom\0"
    "zoomIn\0zoomOut\0centre\0menuHandling\0"
    "QAction*\0a\0menuTriggering"
};
...
void CGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->transformIdentity(); break;
        case 1: _t->initialZoom(); break;
        case 2: _t->zoomIn(); break;
        case 3: _t->zoomOut(); break;
        case 4: _t->centre(); break;
        case 5: _t->menuHandling((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 6: _t->menuTriggering((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject CGLWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_CGLWidget.data,
      qt_meta_data_CGLWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CGLWidget.stringdata))
